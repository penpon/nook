# TASK-009: ZennExplorer collectメソッド実装

## タスク概要
ZennExplorerサービスにBaseService継承とcollectメソッドを実装し、非同期実行を可能にする
...
## worktree名
worktrees/TASK-009-zenn-explorer-collect

## 作業内容

### 1. BaseService継承の追加
- `from nook.common.base_service import BaseService`を追加
- `class ZennExplorer(BaseService):`に変更
- `super().__init__("zenn")`を`__init__`に追加
