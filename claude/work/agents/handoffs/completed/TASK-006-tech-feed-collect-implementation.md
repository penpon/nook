# TASK-006: TechFeed collectメソッド実装

## タスク概要
TechFeedサービスにBaseService継承とcollectメソッドを実装し、非同期実行を可能にする
...
## worktree名
worktrees/TASK-006-tech-feed-collect

## 作業内容

### 1. BaseService継承の追加
- `from nook.common.base_service import BaseService`を追加
- `class TechFeed(BaseService):`に変更
- `super().__init__("tech_feed")`を`__init__`に追加
