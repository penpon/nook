# TASK-010: QiitaExplorer collectメソッド実装

## タスク概要
QiitaExplorerサービスにBaseService継承とcollectメソッドを実装し、非同期実行を可能にする
...
## worktree名
worktrees/TASK-010-qiita-explorer-collect

## 作業内容

### 1. BaseService継承の追加
- `from nook.common.base_service import BaseService`を追加
- `class QiitaExplorer(BaseService):`に変更
- `super().__init__("qiita")`を`__init__`に追加
