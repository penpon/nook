    ...
    <header className="mobile-header dark:bg-gray-900 dark:border-gray-700">
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center">
          {showBackButton && (
            <button onClick={handleBackClick} className="btn-secondary p-2 mr-2" aria-label="戻る">
        ...
        <div className="flex items-center space-x-2">
          ...
          {showSearchButton && (
            <button onClick={handleSearchClick} className="btn-secondary p-2" aria-label="検索">
