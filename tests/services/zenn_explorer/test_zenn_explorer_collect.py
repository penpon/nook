...
class TestRetrieveArticle:
    ...
    async def test_retrieve_article_success(self, zenn_explorer):
        ...
        with patch(
            "nook.services.zenn_explorer.zenn_explorer.parse_entry_datetime"
        ) as mock_parse:
...
class TestCollect:
    ...
    async def test_collect_flow(self, zenn_explorer):
        ...
        with (
            ...
            patch(
                "nook.services.zenn_explorer.zenn_explorer.feedparser.parse"
            ) as mock_parse,
            patch(
            ...
            patch("nook.services.zenn_explorer.zenn_explorer.group_records_by_date"),
...
class TestOtherMethods:
    ...
    async def test_store_summaries(self, zenn_explorer):
        ...
        with patch(
            "nook.services.zenn_explorer.zenn_explorer.store_daily_snapshots",
            new_callable=AsyncMock,
        ) as mock_store:
