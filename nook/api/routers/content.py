...
PAPER_SUMMARY_TITLE_MAPPING = {
    ...
    "4. 制限や問題点は何ですか。本文で言及されているやあなたが考えるものも含めて教えてください": "⚠️ 限界と今後の課題",  # noqa: E501
    "5. 技術的な詳細について。技術者が読むことを想定したトーンで教えてください": "🔧 技術詳細",  # noqa: E501
    "6. コストや物理的な詳細について教えてください。例えばトレーニングに使用したGPUの数や時間、データセット、モデルのサイズなど": "💻 計算リソースと規模",  # noqa: E501
